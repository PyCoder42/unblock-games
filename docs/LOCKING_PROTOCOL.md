...
1. **Primary — jsdelivr.net**: `fetch()` call to `cdn.jsdelivr.net/gh/<repo>@latest/config.json` (CORS-enabled CDN that proxies the latest semver-tagged GitHub version).
